...
| **TTS** | Text-to-speech via Kokoro (local, 9 languages) or ElevenLabs (cloud, 29+ languages). Switchable on the Config page with live preview. |
| **Docker Management** | When running in Docker, the dashboard can restart containers and show their status — no SSH needed. |
