...
::expandable{title="Claude Code" icon="i-lucide-terminal"}
```bash
claude mcp add arilink --transport http http://localhost:3011/mcp
```
::

::expandable{title="VS Code" icon="i-lucide-code"}
`.vscode/mcp.json`
...
::expandable{title="Claude Desktop" icon="i-lucide-message-square"}
...
::expandable{title="Cline" icon="i-lucide-bot"}
...
::expandable{title="Cursor" icon="i-lucide-mouse-pointer"}
```json
{
  "mcpServers": {
    "arilink": {
...
::expandable{title="Windsurf" icon="i-lucide-wind"}
```json
{
  "mcpServers": {
    "arilink": {
...
::expandable{title="Ollama (via ollmcp)" icon="i-lucide-brain"}
```bash
